                ...
                <div class="content" data-v-125b5982="">
                    <div class="title" data-v-125b5982="">
                        <div class="van-image" data-v-125b5982="">
                            ...
                            <img :src="$asseturl+'Recharge/nagad.png'" class="van-image__img" v-else-if="form.method=='Nagad'" style="object-fit: fill;">
                            <img :src="$asseturl+'Recharge/rocket.png'" class="van-image__img" v-else-if="form.method=='Rocket'" style="object-fit: fill;">
